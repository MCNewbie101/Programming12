...
public class Gridder extends javax.swing.JFrame 
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for(int c = 0; c < gridCount; c++)
            for(int r = gridCount / 2; r < gridCount; r++)
                grid[c][r] = 0;
        draw();
    }//GEN-LAST:event_jButton1ActionPerformed
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if (grid[0][gridCount - 1] == 0) {
            int count = 0;
            if (grid[0][gridCount - 2] == 1) {
                count++;
            }
            if (grid[1][gridCount - 2] == 1) {
                count++;
            }
            if (grid[1][gridCount - 1] == 1) {
                count++;
            }
            if (count >= 2) {
                temp[0][gridCount - 1] = 1;
            }
        }
        if (grid[gridCount - 1][0] == 0) {
            int count = 0;
            if (grid[gridCount - 2][0] == 1) {
                count++;
            }
            if (grid[gridCount - 2][1] == 1) {
                count++;
            }
            if (grid[gridCount - 1][1] == 1) {
                count++;
            }
            if (count >= 2) {
                temp[gridCount - 1][0] = 1;
            }
        }
        if (grid[gridCount - 1][gridCount - 1] == 0) {
            int count = 0;
            if (grid[gridCount - 2][gridCount - 2] == 1) {
                count++;
            }
            if (grid[gridCount - 2][gridCount - 1] == 1) {
                count++;
            }
            if (grid[gridCount - 1][gridCount - 2] == 1) {
                count++;
            }
            if (count >= 2) {
                temp[gridCount - 1][gridCount - 1] = 1;
            }
        }
        for (int i = 1; i < gridCount - 1; i++) {
            ...
            if (grid[gridCount - 1][i] == 0) {
                int count = 0;
                if (grid[gridCount - 1][i - 1] == 1) {
                    count++;
                }
                if (grid[gridCount - 1][i + 1] == 1) {
                    count++;
                }
                if (grid[gridCount - 2][i - 1] == 1) {
                    count++;
                }
                if (grid[gridCount - 2][i] == 1) {
                    count++;
                }
                if (grid[gridCount - 2][i + 1] == 1) {
                    count++;
            ...
            if (grid[i][gridCount - 1] == 0) {
                int count = 0;
                if (grid[i - 1][gridCount - 1] == 1) {
                    count++;
                }
                if (grid[i + 1][gridCount - 1] == 1) {
                    count++;
                }
                if (grid[i - 1][gridCount - 2] == 1) {
                    count++;
                }
                if (grid[i][gridCount - 2] == 1) {
                    count++;
                }
                if (grid[i + 1][gridCount - 2] == 1) {
                    count++;
                ...
                if (count >= 2) {
                    temp[i][gridCount - 1] = 1;
                }
            }
        }
        for (int i = 1; i < gridCount - 1; i++) {
            for (int i1 = 1; i1 < gridCount - 1; i1++) {
                if (grid[i][i1] == 0) {
                    int count = 0;
                    if (grid[i - 1][i1 - 1] == 1) {
                        count++;
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        for (int i = 0; i < gridCount; i++) {
            int temp = grid[0][i];
            for (int i1 = 0; i1 < gridCount - 1; i1++) {
                grid[i1][i] = grid[i1 + 1][i];
            }
            grid[gridCount - 1][i] = temp;
        }
        draw();
    }//GEN-LAST:event_jButton11ActionPerformed
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        for (int i = 0; i < gridCount; i++) {
            for (int i1 = 0; i1 < gridCount; i1++) {
                temp[i1][i] = grid[i][gridCount - i1 - 1];
            }
        }
        grid = temp;
        draw();
